...
\- 1 số chú ý với file kickstart cho Ubuntu 16.04:  
- Khi cài OS có 2 disk, nếu không chỉ rõ phải cải trên disk nào, kickstart sẽ tự động chọn disk đầu tiên để cài.
